...
import { CommonService, DataService, SettingsService, apiResultFormat, Routes } from '@frontend/core';
import { PaginationService, expiredproduct, pageSelection, tablePageSize } from '@frontend/shared';
