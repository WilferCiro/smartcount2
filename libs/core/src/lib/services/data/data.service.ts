...
import { productList } from '@frontend/shared';
import { categoryList } from '@frontend/shared';
import { printerList } from '@frontend/shared';
@Injectable({
  providedIn: 'root',
})
export class DataService {
  ...
  public getProductList(): Observable<productList[]> {
    return this.http.get<productList[]>(`${this.baseUrl}1/products`).pipe(
      map((res: productList[]) => {
        return res;
      })
    );
  ...
  public getProductById(id: string) {
    return this.http.get<productList>(`${this.baseUrl}1/products/edit/${id}`);
  }
  public createProduct(productData: productList): Observable<productList> {
    return this.http.post<productList>(`${this.baseUrl}1/products/create`, productData);
  }

  public updateProduct(productData: productList): Observable<productList> {
    const productId = productData.idProduct;
    return this.http.patch<productList>(`${this.baseUrl}1/products/edit-product/${productId}`, productData);
  }
  public deleteProduct(id: number) {
    return this.http.post<object>(this.baseUrl + '1/products/delete', { id: id, dsn: localStorage.getItem("dsn") })
  }
    
  public getCategoryList(): Observable<categoryList[]> {
    return this.http.get<categoryList[]>(`${this.baseUrl}0/categories`).pipe(
      map((res: categoryList[]) => {
        return res;
      })
    );
  }
  public getCategoryById(id: string) {
    return this.http.get<categoryList>(`${this.baseUrl}0/categories/edit/${id}`);
  }
  public createCategory(categoryData: categoryList): Observable<categoryList> {
    return this.http.post<categoryList>(`${this.baseUrl}0/categories/add-category`, categoryData);
  }

  public createSubCategory(id: string, data: object): Observable<categoryList> {
    console.log(data);
    return this.http.patch<categoryList>(`${this.baseUrl}0/categories/${id}/add-subcategory`, data);
  }

  public updateCategory(categoryData: categoryList): Observable<categoryList> {
    const categoryId = categoryData.idCategory;
    return this.http.patch<categoryList>(`${this.baseUrl}0/categories/edit-category/${categoryId}`, categoryData);
  }

  public deleteCategory(id: number) {
    return this.http.delete<object>(this.baseUrl + '0/categories/delete/' + id,)
  }


  public getPrinterList(): Observable<printerList[]> {

    return this.http.get<printerList[]>(`${this.baseUrl}3/printers/`);
  }
  public getPrinterById(id: string) {
    return this.http.get<printerList>(`${this.baseUrl}3/printers/edit/${id}`);
  }
  public createPrinter(pinterData: printerList): Observable<printerList> {
    return this.http.post<printerList>(`${this.baseUrl}3/printers/create`, pinterData);
  }

  public updatePrinter(pinterData: printerList): Observable<printerList> {
    const pinterId = pinterData.idPrinter;
    return this.http.patch<printerList>(`${this.baseUrl}3/printers/edit-pinter/${pinterId}`, pinterData);
  }
  public deletePrinter(id: number) {
    return this.http.post<object>(this.baseUrl + '3/printers/delete', { id: id, dsn: localStorage.getItem("dsn") })
  }
  ...
  public getUserList(): Observable<apiResultFormat> {
    return this.http.get<apiResultFormat>('userList.json').pipe(
      map((res: apiResultFormat) => {
        return res;
      })
    );
