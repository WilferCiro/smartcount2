export interface productList {
  ...
  prodMeasureUnit: number;
  prodWeight: number;
  prodImage: string | null;
  prodCostPrice: number;
  prodBasePrice: number;
  prodAverageCost: number;
  prodPercentageDiscount: number;
  prodInventory: number;
  prodIsRawMaterial: boolean;
  prodIsSale: boolean;
  prodStatusSaleNegative: boolean;
  prodStatusAffectInventory: boolean;
  prodStatus: boolean;
  createdAt?: Date | null;
  updatedAt?: Date | null;
  idCategory: string;
...
export interface categoryList {
  ...
  cateName: string;
  cateSalePrice: number;
  cateDeliveryPrice: number;
  cateColor: string;
  cateState: boolean;
  cateImage: string;
  cateDescription: string;
  cateDiscount: boolean;
